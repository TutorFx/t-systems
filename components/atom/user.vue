<template>
    <div class="text-center max-w-50 user" tabindex="2" >
        <nuxt-link nuxt-link :to="`/${username}`">
            <nuxt-img class="rounded-full user-img" :src="img" width="140" height="140" format="webp" quality="70" />
        </nuxt-link>
        <div class="id text-lg">{{username}}</div>
        <a :href="`https://github.com/${username}`" class="anchor flex w-full gap-2 justify-center items-center text-blue-400 text-xs">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_1790_17)">
